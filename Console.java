...
public class Console extends JFrame implements MouseListener, MouseMotionListener, MouseWheelListener {
   ...
   */
  /**
   *Draws specified GIF on the drawing area. Note: you cannot
   *draw anything on top of GIFs, and that when you invoke this method
   *for best results put it into a thread, like so:
   ...
   * @param height Compress or stretch image to this width
   */
  public void drawGIF(Image img, int x, int y, int width, int height) {
	  canvas.drawGIF(img, x, y, width, height);
   ...
   * @param height Compress or stretch image to this width
   */
  public void drawGIF(Image img, int x, int y) {
	  canvas.drawGIF(img, x, y);
